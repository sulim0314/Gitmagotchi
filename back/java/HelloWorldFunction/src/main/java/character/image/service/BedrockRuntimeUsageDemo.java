...
public class BedrockRuntimeUsageDemo {
    ...
    private static String invoke(String modelId, String prompt) throws IOException {
        return invoke(modelId, prompt, null);
    }

    private static String invoke(String modelId, String prompt, String stylePreset) throws IOException {
        ...
        try {
            switch (modelId) {
                case TITAN_IMAGE:
                    return createImage(TITAN_IMAGE, prompt, random.nextLong() & 0xFFFFFFFL);
                default:
    ...
    private static String createImage(String modelId, String prompt, long seed) throws IOException {
        return createImage(modelId, prompt, seed, null);
    }

    private static String createImage(String modelId, String prompt, long seed, String stylePreset) throws IOException {
    ...
    public static String textToImage(String userInput) throws IOException {
        ...
        return BedrockRuntimeUsageDemo.invoke(TITAN_IMAGE, imagePrompt);
    }

    private static String saveImage(String modelId, String base64ImageData) {
        S3ImageUploader uploader = new S3ImageUploader();

        return uploader.uploadImageToS3("gitmagotchi-character-image", base64ImageData);
